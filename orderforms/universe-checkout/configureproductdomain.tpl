...
function cancelcheck() {
    jQuery("#domainpopupcontainer").slideUp('fast',function() {
...
function completedomain() {
    ...
    jQuery.post("cart.php", 'ajax=1&a=add&billingcycle=biennially&pid={/literal}{$pid}{literal}&domainselect=1&'+jQuery("#domainfrm").serialize(),
    function(data){
        if (data=='') {
            window.location='cart.php?a=view';
        } else if (data=='nodomains') {
            jQuery("#domainpopupcontainer").slideUp('fast',function() {
                jQuery("#greyout").fadeOut('fast');
            });
        } else {
            jQuery("#prodconfigcontainer").html(data);
            jQuery(".domain-fade-out").fadeOut('fast');
            jQuery("#domainpopupcontainer").slideUp('fast',function() {
                jQuery("#greyout").fadeOut('fast');
            });
