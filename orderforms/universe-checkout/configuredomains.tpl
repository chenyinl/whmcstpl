...
<table align="center">
<tr><td width="50%">{$LANG.domainnameserver1}:</td><td><input type="text" name="domainns1" value="{$domainns1}" /></td></tr>
...
<tr><td>{$LANG.domainnameserver5}:</td><td><input type="text" name="domainns5" value="{$domainns5}" /></td></tr>
</table>
</div>
{/if}
