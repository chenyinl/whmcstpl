...
{if $custom4_layout_plans gte '1'}
		...
		<div class="box box1{if $c4hp1_highlight eq "on"} highlight{/if}"{if $c4hp1_productlink} onclick="location.href='{$c4hp1_productlink}';"{/if}>
			...
			<ul>
				{if $LANG.custom4_box1_feat1}<li>{$LANG.custom4_box1_feat1}</li>{/if}
				{if $LANG.custom4_box1_feat2}<li>{$LANG.custom4_box1_feat2}</li>{/if}
				{if $LANG.custom4_box1_feat3}<li>{$LANG.custom4_box1_feat3}</li>{/if}
...
{if $custom4_layout_plans gte '2'}
		...
		<div class="box box2{if $c4hp2_highlight eq "on"} highlight{/if}"{if $c4hp2_productlink} onclick="location.href='{$c4hp2_productlink}';"{/if}>
			<div class="popular"></div>
			
			{if $LANG.custom4_box2_title}
			<div class="title">
				<h2 class="server2">{$LANG.custom4_box2_title}</h2>
			</div>
			{/if}				
			...
			<ul>
				{if $LANG.custom4_box2_feat1}<li>{$LANG.custom4_box2_feat1}</li>{/if}
				{if $LANG.custom4_box2_feat2}<li>{$LANG.custom4_box2_feat2}</li>{/if}
				{if $LANG.custom4_box2_feat3}<li>{$LANG.custom4_box2_feat3}</li>{/if}
...
{if $custom4_layout_plans gte '3'}
		...
		<div class="box box3{if $c4hp3_highlight eq "on"} highlight{/if}"{if $c4hp3_productlink} onclick="location.href='{$c4hp3_productlink}';"{/if}>
			<div class="popular"></div>
			
			{if $LANG.custom4_box3_title}
			<div class="title">
				<h2 class="server3">{$LANG.custom4_box3_title}</h2>
			</div>
			{/if}				
			...
			<ul>
				{if $LANG.custom4_box3_feat1}<li>{$LANG.custom4_box3_feat1}</li>{/if}
				{if $LANG.custom4_box3_feat2}<li>{$LANG.custom4_box3_feat2}</li>{/if}
				{if $LANG.custom4_box3_feat3}<li>{$LANG.custom4_box3_feat3}</li>{/if}
...
{if $custom4_layout_plans gte '4'}
		...
		<div class="box box4{if $c4hp4_highlight eq "on"} highlight{/if}"{if $c4hp4_productlink} onclick="location.href='{$c4hp4_productlink}';"{/if}>
			<div class="popular"></div>
			...
			<ul>
				{if $LANG.custom4_box4_feat1}<li>{$LANG.custom4_box4_feat1}</li>{/if}
				{if $LANG.custom4_box4_feat2}<li>{$LANG.custom4_box4_feat2}</li>{/if}
				{if $LANG.custom4_box4_feat3}<li>{$LANG.custom4_box4_feat3}</li>{/if}
...
{if $custom4_layout_plans gte '5'}
		...
		<div class="box box5{if $c4hp5_highlight eq "on"} highlight{/if}"{if $c4hp5_productlink} onclick="location.href='{$c4hp5_productlink}';"{/if}>
			<div class="popular"></div>
			
			{if $LANG.custom4_box5_title}
			<div class="title">
				<h2 class="server2">{$LANG.custom4_box5_title}</h2>
			</div>
			{/if}			
			...
			<ul>
				{if $LANG.custom4_box5_feat1}<li>{$LANG.custom4_box5_feat1}</li>{/if}
				{if $LANG.custom4_box5_feat2}<li>{$LANG.custom4_box5_feat2}</li>{/if}
				{if $LANG.custom4_box5_feat3}<li>{$LANG.custom4_box5_feat3}</li>{/if}
...
{if $custom4_layout_plans gte '6'}
		...
		<div class="box box6{if $c4hp6_highlight eq "on"} highlight{/if}"{if $c4hp6_productlink} onclick="location.href='{$c4hp6_productlink}';"{/if}>
			<div class="popular"></div>
			
			{if $LANG.custom4_box6_title}
			<div class="title">
				<h2 class="server3">{$LANG.custom4_box6_title}</h2>
			</div>
			{/if}			
			...
			<ul>
				{if $LANG.custom4_box6_feat1}<li>{$LANG.custom4_box6_feat1}</li>{/if}
				{if $LANG.custom4_box6_feat2}<li>{$LANG.custom4_box6_feat2}</li>{/if}
				{if $LANG.custom4_box6_feat3}<li>{$LANG.custom4_box6_feat3}</li>{/if}
...
{else}
			...
			<div class="pricingtable pricingtable{if $custom4_layout_plans eq '1'}1{elseif $custom4_layout_plans eq '2'}2{elseif $custom4_layout_plans eq '3'}3{elseif $custom4_layout_plans eq '4'}4{elseif $custom4_layout_plans eq '5'}5{elseif $custom4_layout_plans eq '6'}6{/if}">
				...
				{if $custom4_layout_plans gte '1'}							
					...
					<div class="block box1{if $custom4_layout_plans eq '1'} nomarginright{/if}{if $c4hp1_highlight eq "on"} highlight{/if}"{if $c4hp1_productlink} onclick="location.href='{$c4hp1_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom4_layout_plans gte '2'}							
					...
					<div class="block box2{if $custom4_layout_plans eq '2'} nomarginright{/if}{if $c4hp2_highlight eq "on"} highlight{/if}"{if $c4hp2_productlink} onclick="location.href='{$c4hp2_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom4_layout_plans gte '3'}							
					...
					<div class="block box3{if $custom4_layout_plans eq '3'} nomarginright{/if}{if $c4hp3_highlight eq "on"} highlight{/if}"{if $c4hp3_productlink} onclick="location.href='{$c4hp3_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom4_layout_plans gte '4'}							
					...
					<div class="block box4{if $custom4_layout_plans eq '4'} nomarginright{/if}{if $c4hp4_highlight eq "on"} highlight{/if}"{if $c4hp4_productlink} onclick="location.href='{$c4hp4_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom4_layout_plans gte '5'}							
					...
					<div class="block box5{if $custom4_layout_plans eq '5'} nomarginright{/if}{if $c4hp5_highlight eq "on"} highlight{/if}"{if $c4hp5_productlink} onclick="location.href='{$c4hp5_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom4_layout_plans gte '6'}							
					...
					<div class="block box6{if $custom4_layout_plans eq '6'} nomarginright{/if}{if $c4hp6_highlight eq "on"} highlight{/if}"{if $c4hp6_productlink} onclick="location.href='{$c4hp6_productlink}';"{/if}>
						<div class="popular"></div>
...
{if $custom4_layout_plans gte '1'}
		...
		<div class="box box1{if $c4hp1_highlight eq "on"} highlight{/if}"{if $c4hp1_productlink} onclick="location.href='{$c4hp1_productlink}';"{/if}>
			...
			<ul>
				{if $c4hp1_bfeat1}<li>{$c4hp1_bfeat1}</li>{/if}
				{if $c4hp1_bfeat2}<li>{$c4hp1_bfeat2}</li>{/if}
				{if $c4hp1_bfeat3}<li>{$c4hp1_bfeat3}</li>{/if}
...
{if $custom4_layout_plans gte '2'}
		...
		<div class="box box2{if $c4hp2_highlight eq "on"} highlight{/if}"{if $c4hp2_productlink} onclick="location.href='{$c4hp2_productlink}';"{/if}>
			...
			{if $c4hp2_name}
			<div class="title">
				<h2 class="server2">{$c4hp2_name}</h2>
			</div>
			{/if}			
			...
			<ul>
				{if $c4hp2_bfeat1}<li>{$c4hp2_bfeat1}</li>{/if}
				{if $c4hp2_bfeat2}<li>{$c4hp2_bfeat2}</li>{/if}
				{if $c4hp2_bfeat3}<li>{$c4hp2_bfeat3}</li>{/if}
...
{if $custom4_layout_plans gte '3'}
		...
		<div class="box box3{if $c4hp3_highlight eq "on"} highlight{/if}"{if $c4hp3_productlink} onclick="location.href='{$c4hp3_productlink}';"{/if}>
			...
			{if $c4hp3_name}
			<div class="title">
				<h2 class="server3">{$c4hp3_name}</h2>
			</div>
			{/if}			
			...
			<ul>
				{if $c4hp3_bfeat1}<li>{$c4hp3_bfeat1}</li>{/if}
				{if $c4hp3_bfeat2}<li>{$c4hp3_bfeat2}</li>{/if}
				{if $c4hp3_bfeat3}<li>{$c4hp3_bfeat3}</li>{/if}
...
{if $custom4_layout_plans gte '4'}
		...
		<div class="box box4{if $c4hp4_highlight eq "on"} highlight{/if}"{if $c4hp4_productlink} onclick="location.href='{$c4hp4_productlink}';"{/if}>
			...
			<ul>
				{if $c4hp4_bfeat1}<li>{$c4hp4_bfeat1}</li>{/if}
				{if $c4hp4_bfeat2}<li>{$c4hp4_bfeat2}</li>{/if}
				{if $c4hp4_bfeat3}<li>{$c4hp4_bfeat3}</li>{/if}
...
{if $custom4_layout_plans gte '5'}
		...
		<div class="box box5{if $c4hp5_highlight eq "on"} highlight{/if}"{if $c4hp5_productlink} onclick="location.href='{$c4hp5_productlink}';"{/if}>
			...
			{if $c4hp5_name}
			<div class="title">
				<h2 class="server2">{$c4hp5_name}</h2>
			</div>
			{/if}		
			...
			<ul>
				{if $c4hp5_bfeat1}<li>{$c4hp5_bfeat1}</li>{/if}
				{if $c4hp5_bfeat2}<li>{$c4hp5_bfeat2}</li>{/if}
				{if $c4hp5_bfeat3}<li>{$c4hp5_bfeat3}</li>{/if}
...
{if $custom4_layout_plans gte '6'}
		...
		<div class="box box6{if $c4hp6_highlight eq "on"} highlight{/if}"{if $c4hp6_productlink} onclick="location.href='{$c4hp6_productlink}';"{/if}>
			...
			{if $c4hp6_name}
			<div class="title">
				<h2 class="server3">{$c4hp6_name}</h2>
			</div>
			{/if}	
			...
			<ul>
				{if $c4hp6_bfeat1}<li>{$c4hp6_bfeat1}</li>{/if}
				{if $c4hp6_bfeat2}<li>{$c4hp6_bfeat2}</li>{/if}
				{if $c4hp6_bfeat3}<li>{$c4hp6_bfeat3}</li>{/if}
