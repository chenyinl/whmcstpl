...
{if $custom6_layout_plans gte '1'}
		...
		<div class="box box1{if $c6hp1_highlight eq "on"} highlight{/if}"{if $c6hp1_productlink} onclick="location.href='{$c6hp1_productlink}';"{/if}>
			...
			<ul>
				{if $LANG.custom6_box1_feat1}<li>{$LANG.custom6_box1_feat1}</li>{/if}
				{if $LANG.custom6_box1_feat2}<li>{$LANG.custom6_box1_feat2}</li>{/if}
				{if $LANG.custom6_box1_feat3}<li>{$LANG.custom6_box1_feat3}</li>{/if}
...
{if $custom6_layout_plans gte '2'}
		...
		<div class="box box2{if $c6hp2_highlight eq "on"} highlight{/if}"{if $c6hp2_productlink} onclick="location.href='{$c6hp2_productlink}';"{/if}>
			<div class="popular"></div>
			
			{if $LANG.custom6_box2_title}
			<div class="title">
				<h2 class="server2">{$LANG.custom6_box2_title}</h2>
			</div>
			{/if}				
			...
			<ul>
				{if $LANG.custom6_box2_feat1}<li>{$LANG.custom6_box2_feat1}</li>{/if}
				{if $LANG.custom6_box2_feat2}<li>{$LANG.custom6_box2_feat2}</li>{/if}
				{if $LANG.custom6_box2_feat3}<li>{$LANG.custom6_box2_feat3}</li>{/if}
...
{if $custom6_layout_plans gte '3'}
		...
		<div class="box box3{if $c6hp3_highlight eq "on"} highlight{/if}"{if $c6hp3_productlink} onclick="location.href='{$c6hp3_productlink}';"{/if}>
			<div class="popular"></div>
			
			{if $LANG.custom6_box3_title}
			<div class="title">
				<h2 class="server3">{$LANG.custom6_box3_title}</h2>
			</div>
			{/if}				
			...
			<ul>
				{if $LANG.custom6_box3_feat1}<li>{$LANG.custom6_box3_feat1}</li>{/if}
				{if $LANG.custom6_box3_feat2}<li>{$LANG.custom6_box3_feat2}</li>{/if}
				{if $LANG.custom6_box3_feat3}<li>{$LANG.custom6_box3_feat3}</li>{/if}
...
{if $custom6_layout_plans gte '4'}
		...
		<div class="box box4{if $c6hp4_highlight eq "on"} highlight{/if}"{if $c6hp4_productlink} onclick="location.href='{$c6hp4_productlink}';"{/if}>
			<div class="popular"></div>
			...
			<ul>
				{if $LANG.custom6_box4_feat1}<li>{$LANG.custom6_box4_feat1}</li>{/if}
				{if $LANG.custom6_box4_feat2}<li>{$LANG.custom6_box4_feat2}</li>{/if}
				{if $LANG.custom6_box4_feat3}<li>{$LANG.custom6_box4_feat3}</li>{/if}
...
{if $custom6_layout_plans gte '5'}
		...
		<div class="box box5{if $c6hp5_highlight eq "on"} highlight{/if}"{if $c6hp5_productlink} onclick="location.href='{$c6hp5_productlink}';"{/if}>
			<div class="popular"></div>
			
			{if $LANG.custom6_box5_title}
			<div class="title">
				<h2 class="server2">{$LANG.custom6_box5_title}</h2>
			</div>
			{/if}			
			...
			<ul>
				{if $LANG.custom6_box5_feat1}<li>{$LANG.custom6_box5_feat1}</li>{/if}
				{if $LANG.custom6_box5_feat2}<li>{$LANG.custom6_box5_feat2}</li>{/if}
				{if $LANG.custom6_box5_feat3}<li>{$LANG.custom6_box5_feat3}</li>{/if}
...
{if $custom6_layout_plans gte '6'}
		...
		<div class="box box6{if $c6hp6_highlight eq "on"} highlight{/if}"{if $c6hp6_productlink} onclick="location.href='{$c6hp6_productlink}';"{/if}>
			<div class="popular"></div>
			
			{if $LANG.custom6_box6_title}
			<div class="title">
				<h2 class="server3">{$LANG.custom6_box6_title}</h2>
			</div>
			{/if}			
			...
			<ul>
				{if $LANG.custom6_box6_feat1}<li>{$LANG.custom6_box6_feat1}</li>{/if}
				{if $LANG.custom6_box6_feat2}<li>{$LANG.custom6_box6_feat2}</li>{/if}
				{if $LANG.custom6_box6_feat3}<li>{$LANG.custom6_box6_feat3}</li>{/if}
...
{else}
			...
			<div class="pricingtable pricingtable{if $custom6_layout_plans eq '1'}1{elseif $custom6_layout_plans eq '2'}2{elseif $custom6_layout_plans eq '3'}3{elseif $custom6_layout_plans eq '4'}4{elseif $custom6_layout_plans eq '5'}5{elseif $custom6_layout_plans eq '6'}6{/if}">
				...
				{if $custom6_layout_plans gte '1'}							
					...
					<div class="block box1{if $custom6_layout_plans eq '1'} nomarginright{/if}{if $c6hp1_highlight eq "on"} highlight{/if}"{if $c6hp1_productlink} onclick="location.href='{$c6hp1_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom6_layout_plans gte '2'}							
					...
					<div class="block box2{if $custom6_layout_plans eq '2'} nomarginright{/if}{if $c6hp2_highlight eq "on"} highlight{/if}"{if $c6hp2_productlink} onclick="location.href='{$c6hp2_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom6_layout_plans gte '3'}							
					...
					<div class="block box3{if $custom6_layout_plans eq '3'} nomarginright{/if}{if $c6hp3_highlight eq "on"} highlight{/if}"{if $c6hp3_productlink} onclick="location.href='{$c6hp3_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom6_layout_plans gte '4'}							
					...
					<div class="block box4{if $custom6_layout_plans eq '4'} nomarginright{/if}{if $c6hp4_highlight eq "on"} highlight{/if}"{if $c6hp4_productlink} onclick="location.href='{$c6hp4_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom6_layout_plans gte '5'}							
					...
					<div class="block box5{if $custom6_layout_plans eq '5'} nomarginright{/if}{if $c6hp5_highlight eq "on"} highlight{/if}"{if $c6hp5_productlink} onclick="location.href='{$c6hp5_productlink}';"{/if}>
						<div class="popular"></div>
				...
				{if $custom6_layout_plans gte '6'}							
					...
					<div class="block box6{if $custom6_layout_plans eq '6'} nomarginright{/if}{if $c6hp6_highlight eq "on"} highlight{/if}"{if $c6hp6_productlink} onclick="location.href='{$c6hp6_productlink}';"{/if}>
						<div class="popular"></div>
...
{if $custom6_layout_plans gte '1'}
		...
		<div class="box box1{if $c6hp1_highlight eq "on"} highlight{/if}"{if $c6hp1_productlink} onclick="location.href='{$c6hp1_productlink}';"{/if}>
			...
			<ul>
				{if $c6hp1_bfeat1}<li>{$c6hp1_bfeat1}</li>{/if}
				{if $c6hp1_bfeat2}<li>{$c6hp1_bfeat2}</li>{/if}
				{if $c6hp1_bfeat3}<li>{$c6hp1_bfeat3}</li>{/if}
...
{if $custom6_layout_plans gte '2'}
		...
		<div class="box box2{if $c6hp2_highlight eq "on"} highlight{/if}"{if $c6hp2_productlink} onclick="location.href='{$c6hp2_productlink}';"{/if}>
			...
			{if $c6hp2_name}
			<div class="title">
				<h2 class="server2">{$c6hp2_name}</h2>
			</div>
			{/if}			
			...
			<ul>
				{if $c6hp2_bfeat1}<li>{$c6hp2_bfeat1}</li>{/if}
				{if $c6hp2_bfeat2}<li>{$c6hp2_bfeat2}</li>{/if}
				{if $c6hp2_bfeat3}<li>{$c6hp2_bfeat3}</li>{/if}
...
{if $custom6_layout_plans gte '3'}
		...
		<div class="box box3{if $c6hp3_highlight eq "on"} highlight{/if}"{if $c6hp3_productlink} onclick="location.href='{$c6hp3_productlink}';"{/if}>
			...
			{if $c6hp3_name}
			<div class="title">
				<h2 class="server3">{$c6hp3_name}</h2>
			</div>
			{/if}			
			...
			<ul>
				{if $c6hp3_bfeat1}<li>{$c6hp3_bfeat1}</li>{/if}
				{if $c6hp3_bfeat2}<li>{$c6hp3_bfeat2}</li>{/if}
				{if $c6hp3_bfeat3}<li>{$c6hp3_bfeat3}</li>{/if}
...
{if $custom6_layout_plans gte '4'}
		...
		<div class="box box4{if $c6hp4_highlight eq "on"} highlight{/if}"{if $c6hp4_productlink} onclick="location.href='{$c6hp4_productlink}';"{/if}>
			...
			<ul>
				{if $c6hp4_bfeat1}<li>{$c6hp4_bfeat1}</li>{/if}
				{if $c6hp4_bfeat2}<li>{$c6hp4_bfeat2}</li>{/if}
				{if $c6hp4_bfeat3}<li>{$c6hp4_bfeat3}</li>{/if}
...
{if $custom6_layout_plans gte '5'}
		...
		<div class="box box5{if $c6hp5_highlight eq "on"} highlight{/if}"{if $c6hp5_productlink} onclick="location.href='{$c6hp5_productlink}';"{/if}>
			...
			{if $c6hp5_name}
			<div class="title">
				<h2 class="server2">{$c6hp5_name}</h2>
			</div>
			{/if}		
			...
			<ul>
				{if $c6hp5_bfeat1}<li>{$c6hp5_bfeat1}</li>{/if}
				{if $c6hp5_bfeat2}<li>{$c6hp5_bfeat2}</li>{/if}
				{if $c6hp5_bfeat3}<li>{$c6hp5_bfeat3}</li>{/if}
...
{if $custom6_layout_plans gte '6'}
		...
		<div class="box box6{if $c6hp6_highlight eq "on"} highlight{/if}"{if $c6hp6_productlink} onclick="location.href='{$c6hp6_productlink}';"{/if}>
			...
			{if $c6hp6_name}
			<div class="title">
				<h2 class="server3">{$c6hp6_name}</h2>
			</div>
			{/if}	
			...
			<ul>
				{if $c6hp6_bfeat1}<li>{$c6hp6_bfeat1}</li>{/if}
				{if $c6hp6_bfeat2}<li>{$c6hp6_bfeat2}</li>{/if}
				{if $c6hp6_bfeat3}<li>{$c6hp6_bfeat3}</li>{/if}
