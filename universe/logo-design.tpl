...
<div class="integrationgrid">		
	...
	<div class="boldbox">
		...
		<div class="leftside">
			<a href="http://www.templategenie.com/clients/aff.php?aff={$addons_affid}&page=logo-design" target="_blank"><img src="https://www.templategenie.com/libs/images/custom-logo-design.png" alt="custom logo design" class="img-responsive" /></a>
		</div>
		
		<div class="rightside">
			<h2>{$LANG.logodesigntitle}</h2>
			
			<p>{$LANG.addons_logodesign_1}</p>
			
			<ul class="checklist">
				<li>{$LANG.addons_logodesign_2}</li>
				<li>{$LANG.addons_logodesign_3}</li>
			</ul>
			
			<p class="centercontents buttons"><a href="http://www.templategenie.com/clients/aff.php?aff={$addons_affid}&page=logo-design" target="_blank" class="button1 color2">{$LANG.addons_learn}</a><a href="http://www.templategenie.com/clients/aff.php?aff={$addons_affid}&page=logo-design-order" target="_blank" class="button1 color1">{$LANG.addons_logodesign_order}</a></p>
		</div>		
...
<iframe class="affiframe" width="100%" scrolling="no" frameborder="0" src="https://www.templategenie.com/clients/aff.php?aff={$addons_affid}&page=whitelabel-logodesign" onload="scrolltotop();"></iframe>
